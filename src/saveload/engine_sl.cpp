...
static const SaveLoad _engine_desc[] = {
	 ...
	 SLE_CONDVAR(Engine, age,                 SLE_INT32,                  SLV_31, SL_MAX_VERSION),
        ...
        SLE_CONDVAR(Engine, preview_asked,       SLE_UINT16,                SLV_179, SLV_EXPAND_COMPANY_SLOTS),
        SLE_CONDVAR(Engine, preview_asked,       SLE_UINT64,               SLV_EXPAND_COMPANY_SLOTS, SL_MAX_VERSION),
        ...
        SLE_CONDVAR(Engine, company_avail,       SLE_UINT16,                SLV_104, SLV_EXPAND_COMPANY_SLOTS),
        SLE_CONDVAR(Engine, company_avail,       SLE_UINT64,                SLV_EXPAND_COMPANY_SLOTS, SL_MAX_VERSION),
        SLE_CONDVAR(Engine, company_hidden,      SLE_UINT16,                SLV_193, SLV_EXPAND_COMPANY_SLOTS),
        SLE_CONDVAR(Engine, company_hidden,      SLE_UINT64,                SLV_EXPAND_COMPANY_SLOTS, SL_MAX_VERSION),
