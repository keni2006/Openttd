...
static const SaveLoad _company_desc[] = {
	...
	SLE_CONDVAR(CompanyProperties, inaugurated_year_calendar, SLE_INT32,               SLV_COMPANY_INAUGURATED_PERIOD_V2, SL_MAX_VERSION),
        ...
        SLE_CONDVAR(CompanyProperties, bankrupt_asked,        SLE_UINT16,                SLV_104, SLV_EXPAND_COMPANY_SLOTS),
        SLE_CONDVAR(CompanyProperties, bankrupt_asked,        SLE_UINT64,                SLV_EXPAND_COMPANY_SLOTS, SL_MAX_VERSION),
